...
DEFAULT_DRONE_PATH = "/home/shuyi/difflyingacross/examples/crazyflie.usd"  # Path to input drone asset
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="/home/shuyi/difflyingacross/examples/crazyflie.usd",
