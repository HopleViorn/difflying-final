...
class task_config:
    ...
    # 奖励参数
    reward_parameters = {
        "pos_reward_magnitude": 5.0,           # 位置奖励系数
        ...
        "x_action_diff_penalty_magnitude": 0.8,      # x 方向动作差异惩罚系数
        "x_action_diff_penalty_exponent": 3.333,     # x 方向动作差异惩罚指数
        "z_action_diff_penalty_magnitude": 0.8,      # z 方向动作差异惩罚系数
        "z_action_diff_penalty_exponent": 5.0,       # z 方向动作差异惩罚指数
        "yawrate_action_diff_penalty_magnitude": 0.8,  # 偏航速率动作差异惩罚系数
        ...
        "crash_penalty": -1000,                           # 坠机惩罚
        "attitude_reward_magnitude": 2.0,                  # 姿态奖励系数
        "velocity_reward_magnitude": 3.0,                  # 速度奖励系数
        "thrust_balance_magnitude": 10.0,                   # 推力均衡奖励系数
    }
    ...
    #     # 将 x 方向的动作调整到 [0, 2] 范围
    #     clamped_action[:, 0] = clamped_action[:, 0] + 1.0
